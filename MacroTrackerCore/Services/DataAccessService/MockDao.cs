...
public class MockDao : IDao
{
    ...
    public void AddFood(Food food) => throw new NotImplementedException();

    /// <summary>
    /// Removes a food item by name.
    /// </summary>
    /// <param name="foodName">The name of the food item to remove.</param>
    public void RemoveFood(string foodName) => throw new NotImplementedException();
    ...
    {
        new Exercise { IconFileName = "basketball.png", Name = "Basketball", CaloriesPerMinute = 7.5 },
        new Exercise { IconFileName = "climbing.png", Name = "Climbing", CaloriesPerMinute = 8.0 },
        new Exercise { IconFileName = "martialarts.png", Name = "Martial Arts", CaloriesPerMinute = 6.0 },
        new Exercise { IconFileName = "running.png", Name = "Running", CaloriesPerMinute = 11.0 },
        new Exercise { IconFileName = "swimming.png", Name = "Swimming", CaloriesPerMinute = 9.0 },
        new Exercise { IconFileName = "pickleball.png", Name = "Pickle Ball", CaloriesPerMinute = 6.0 },
        new Exercise { IconFileName = "tennis.png", Name = "Tennis", CaloriesPerMinute = 7.0 },
        new Exercise { IconFileName = "volleyball.png", Name = "Volleyball", CaloriesPerMinute = 6.0 },
        new Exercise { IconFileName = "walking.png", Name = "Walking", CaloriesPerMinute = 4.0 },
        new Exercise { IconFileName = "weightlifting.png", Name = "Weight Lifting", CaloriesPerMinute = 5.0 },
        new Exercise { IconFileName = "yoga.png", Name = "Yoga", CaloriesPerMinute = 3.0 },
        new Exercise { IconFileName = "pilates.png", Name = "Pilates", CaloriesPerMinute = 3.0 },
        new Exercise { IconFileName = "baseball.png", Name = "Baseball", CaloriesPerMinute = 5.0 },
    };
    ...
    public void AddExercise(Exercise exercise) => throw new NotImplementedException();

    /// <summary>
    /// Removes an exercise by name.
    /// </summary>
    /// <param name="exerciseName">The name of the exercise to remove.</param>
    public void RemoveExercise(string exerciseName) => throw new NotImplementedException();

    /// <summary>
    /// Gets the goal.
    /// </summary>
    /// <returns>A <see cref="Goal"/> object.</returns>
    public Goal GetGoal() => new Goal { Calories = 2500, Protein = 156, Carbs = 313, Fat = 69 };

    /// <summary>
    /// Updates the goal.
    /// </summary>
    /// <param name="goal">The goal to update.</param>
    public void UpdateGoal(Goal goal) => throw new NotImplementedException();

    /// <summary>
    /// Collection of mock users.
    /// </summary>
    private List<User> UserList { get; } = new()
    {
        new User
        {
            Username = "admin",
            EncryptedPassword = ProviderCore.GetServiceProvider()
    ...
    public bool DoesUserMatchPassword(string username, string password)
    {
        ...
        if (indexUsername == -1) return false;
    ...
    public bool DoesUsernameExist(string username) => FindUsernameIndex(GetUsers(), username) != -1;
    ...
    public void DeleteLog(int logId) => Logs.Remove(Logs.First(log => log.LogId == logId));
    ...
    private List<Log> Logs { get; } = new()
    {
        new Log
        {
            ...
            {
                new LogFoodItem { LogId = 1, LogFoodId = 1, FoodName = "Apple", NumberOfServings = 2, TotalCalories = 24 },
                new LogFoodItem { LogId = 1, LogFoodId = 2, FoodName = "Banana", NumberOfServings = 3, TotalCalories = 48 },
            },
        ...
        new Log
        {
            ...
            LogExerciseItems = new ObservableCollection<LogExerciseItem>
            {
                new LogExerciseItem { LogId = 2, LogExerciseId = 1, ExerciseName = "Basketball", Duration = 15, TotalCalories = -23 },
            },
            LogFoodItems = new ObservableCollection<LogFoodItem>
            {
                new LogFoodItem { LogId = 2, LogFoodId = 1, FoodName = "Coconut", NumberOfServings = 2, TotalCalories = 40 },
            },
            TotalCalories = 0
        },
        new Log
        {
            ...
            LogExerciseItems = new ObservableCollection<LogExerciseItem>
            {
                new LogExerciseItem { LogId = 3, LogExerciseId = 1, ExerciseName = "Yoga", Duration = 30, TotalCalories = -14.4f },
            },
            LogFoodItems = new ObservableCollection<LogFoodItem>
            {
                new LogFoodItem { LogId = 3, LogFoodId = 1, FoodName = "Meme", NumberOfServings = 10, TotalCalories = 100 },
                new LogFoodItem { LogId = 3, LogFoodId = 2, FoodName = "Coke", NumberOfServings = 3, TotalCalories = 300 },
                new LogFoodItem { LogId = 3, LogFoodId = 3, FoodName = "Pasta", NumberOfServings = 1, TotalCalories = 150 },
            },
            TotalCalories = 0
        },
        new Log
    ...
    {
        Log log = Logs.First(log => log.LogId == idLog);
        log.LogExerciseItems.Remove(log.LogExerciseItems.First(logExercise => logExercise.LogExerciseId == idLogExercise));
    }
    ...
    public List<Log> GetLogWithPagination(int numberItemOffset, DateOnly endDate) =>
        GetLogWithPagination(Configuration.PAGINATION_NUMBER, numberItemOffset, endDate);
    ...
    public List<Log> GetLogWithPagination(int n, int numberItemOffset, DateOnly endDate) =>
        Logs.OrderByDescending(log => log.LogDate)
