...
-- Thêm dữ liệu vào bảng logs (10 logs)
...
-- Thêm dữ liệu vào bảng log_food_items (mỗi log có 5 món ăn)
...
-- Thêm dữ liệu vào bảng log_exercise_items (mỗi log có 2 bài tập)
...
select * from foods;
select * from goal;
select * from log_exercise_items;
select * from log_food_items;
select * from logs;
select * from users;
